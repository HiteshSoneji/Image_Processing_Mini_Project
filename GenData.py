...
###################################################################################################
def main():
    imgTrainingNumbers = cv2.imread("Training_Datasets/training_chars.png")  # read in training numbers image
    imgTrainingNumbers1 = cv2.imread("Training_Datasets/training_chars_small.png")
